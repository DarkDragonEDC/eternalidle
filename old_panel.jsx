            ...
            >
                ...
                <div style={{ color: 'var(--text-dim)', fontSize: '0.75rem', lineHeight: '1.4', display: 'flex', flexDirection: 'column', gap: '8px' }}>
                    <div style={{ display: 'flex', gap: '10px', alignItems: 'flex-start', background: 'var(--accent-soft)', padding: '10px', borderRadius: '10px' }}>
                        <span style={{ fontSize: '1.2rem', lineHeight: '1' }}>ΓÅ░</span>
                        <div>
                    ...
                    <div style={{ display: 'flex', gap: '10px', alignItems: 'flex-start', background: 'var(--accent-soft)', padding: '10px', borderRadius: '10px' }}>
                        <span style={{ fontSize: '1.2rem', lineHeight: '1' }}>ΓÜö∩╕Å</span>
                        <div>
                    ...
                    <div style={{ display: 'flex', gap: '10px', alignItems: 'flex-start', background: 'var(--accent-soft)', padding: '10px', borderRadius: '10px' }}>
                        <span style={{ fontSize: '1.2rem', lineHeight: '1' }}>≡ƒÅå</span>
                        <div>
                    ...
                    <div style={{ display: 'flex', gap: '10px', alignItems: 'flex-start', background: 'var(--accent-soft)', padding: '10px', borderRadius: '10px' }}>
                        <span style={{ fontSize: '1.2rem', lineHeight: '1' }}>≡ƒÆÄ</span>
                        <div>
                                    ...
                                    {myRank && (
                                        <div style={{
                                            ...
                                            <span style={{ color: '#22c55e', fontWeight: '700', fontSize: '0.9rem', letterSpacing: '1px' }}>
                                                CHALLENGED TODAY ΓÇö RANK #{myRank.pos}
                                            </span>
                                        </div>
                                    )}
                                </div>
                                            ...
                                            <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
                                                ...
                                                <div>
                                                    ...
                                                    <div style={{ fontSize: '0.75rem', color: 'var(--text-dim)', marginTop: '2px', display: 'flex', flexDirection: 'column', gap: '2px' }}>
                                                        <span>From {new Date(pendingReward.date).toLocaleDateString()} ΓÇó <span style={{ color: 'var(--text-main)' }}>Rank #{pendingReward.rank}</span></span>
                                                ...
                                                <div style={{ flex: 1, marginLeft: isMobile ? '12px' : '16px', overflow: 'hidden' }}>
                                                    <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                                                        ...
                                                        >
                                                            ...
                                                            {rank.isIronman && <span title="Ironman" style={{ fontSize: '0.8rem' }}>≡ƒ¢í∩╕Å</span>}
                                                            {rank.name}
                                                        </span>
                                                        {isMe && <span style={{ fontSize: '0.65rem', opacity: 0.5, fontWeight: '700', textTransform: 'uppercase', letterSpacing: '0.5px' }}>ΓÇö yours</span>}
                                                    </div>
