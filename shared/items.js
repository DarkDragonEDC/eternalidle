...
if (ITEMS.GEAR.WARRIORS_FORGE.PLATE_ARMOR[1]) { ITEMS.GEAR.WARRIORS_FORGE.PLATE_ARMOR[1].icon = '/items/T1_PLATE_ARMOR.webp'; ITEMS.GEAR.WARRIORS_FORGE.PLATE_ARMOR[1].scale = '200%'; }
if (ITEMS.GEAR.WARRIORS_FORGE.PLATE_ARMOR[2]) { ITEMS.GEAR.WARRIORS_FORGE.PLATE_ARMOR[2].icon = '/items/T2_PLATE_ARMOR.webp'; ITEMS.GEAR.WARRIORS_FORGE.PLATE_ARMOR[2].scale = '200%'; }
if (ITEMS.GEAR.WARRIORS_FORGE.PLATE_ARMOR[3]) { ITEMS.GEAR.WARRIORS_FORGE.PLATE_ARMOR[3].icon = '/items/T3_PLATE_ARMOR.webp'; ITEMS.GEAR.WARRIORS_FORGE.PLATE_ARMOR[3].scale = '200%'; }
if (ITEMS.GEAR.WARRIORS_FORGE.PLATE_ARMOR[4]) { ITEMS.GEAR.WARRIORS_FORGE.PLATE_ARMOR[4].icon = '/items/T4_PLATE_ARMOR.webp'; ITEMS.GEAR.WARRIORS_FORGE.PLATE_ARMOR[4].scale = '200%'; }
if (ITEMS.GEAR.WARRIORS_FORGE.PLATE_ARMOR[5]) { ITEMS.GEAR.WARRIORS_FORGE.PLATE_ARMOR[5].icon = '/items/T5_PLATE_ARMOR.webp'; ITEMS.GEAR.WARRIORS_FORGE.PLATE_ARMOR[5].scale = '200%'; }
if (ITEMS.GEAR.WARRIORS_FORGE.PLATE_ARMOR[6]) { ITEMS.GEAR.WARRIORS_FORGE.PLATE_ARMOR[6].icon = '/items/T6_PLATE_ARMOR.webp'; ITEMS.GEAR.WARRIORS_FORGE.PLATE_ARMOR[6].scale = '200%'; }
if (ITEMS.GEAR.WARRIORS_FORGE.PLATE_ARMOR[7]) { ITEMS.GEAR.WARRIORS_FORGE.PLATE_ARMOR[7].icon = '/items/T7_PLATE_ARMOR.webp'; ITEMS.GEAR.WARRIORS_FORGE.PLATE_ARMOR[7].scale = '200%'; }
if (ITEMS.GEAR.WARRIORS_FORGE.PLATE_ARMOR[8]) { ITEMS.GEAR.WARRIORS_FORGE.PLATE_ARMOR[8].icon = '/items/T8_PLATE_ARMOR.webp'; ITEMS.GEAR.WARRIORS_FORGE.PLATE_ARMOR[8].scale = '200%'; }
if (ITEMS.GEAR.WARRIORS_FORGE.PLATE_ARMOR[9]) { ITEMS.GEAR.WARRIORS_FORGE.PLATE_ARMOR[9].icon = '/items/T9_PLATE_ARMOR.webp'; ITEMS.GEAR.WARRIORS_FORGE.PLATE_ARMOR[9].scale = '200%'; }
if (ITEMS.GEAR.WARRIORS_FORGE.PLATE_ARMOR[10]) { ITEMS.GEAR.WARRIORS_FORGE.PLATE_ARMOR[10].icon = '/items/T10_PLATE_ARMOR.webp'; ITEMS.GEAR.WARRIORS_FORGE.PLATE_ARMOR[10].scale = '200%'; }
