export const MONSTERS = {
    1: [
        { id: 'RABBIT', name: 'Rabbit', health: 120, damage: 6, defense: 2, xp: 25, loot: { 'T1_DUNGEON_MAP': 0.01 }, silver: [5, 15], tier: 1, image: 'rabbit.png', flipCombat: true, flipList: true },
        { id: 'GOBLIN_SCOUT', name: 'Goblin Scout', health: 180, damage: 8, defense: 4, xp: 45, loot: { 'T1_DUNGEON_MAP': 0.02 }, silver: [12, 25], tier: 1, image: 'goblin_scout.png' },
    ...
    2: [
        { id: 'WOLF', name: 'Wolf', health: 400, damage: 18, defense: 10, xp: 60, loot: { 'T2_DUNGEON_MAP': 0.01 }, silver: [20, 40], tier: 2, image: 'wolf.png' },
        { id: 'DIRE_RAT', name: 'Dire Rat', health: 600, damage: 22, defense: 15, xp: 100, loot: { 'T2_DUNGEON_MAP': 0.02 }, silver: [30, 60], tier: 2, image: 'dire_rat.png' },
    ...
    3: [
        { id: 'BEAR', name: 'Bear', health: 1100, damage: 50, defense: 30, xp: 150, loot: { 'T3_DUNGEON_MAP': 0.01 }, silver: [60, 120], tier: 3, image: 'bear.png' },
        { id: 'MOUNTAIN_GOBLIN', name: 'Mountain Goblin', health: 1600, damage: 65, defense: 45, xp: 250, loot: { 'T3_DUNGEON_MAP': 0.02 }, silver: [90, 180], tier: 3, image: 'mountain_goblin.png' },
    ...
    4: [
        { id: 'DIRE_WOLF', name: 'Dire Wolf', health: 3500, damage: 160, defense: 80, xp: 400, loot: { 'T4_DUNGEON_MAP': 0.01 }, silver: [200, 400], tier: 4, image: 'dire_wolf.png' },
        { id: 'GHOST_KNIGHT', name: 'Ghost Knight', health: 5000, damage: 200, defense: 110, xp: 650, loot: { 'T4_DUNGEON_MAP': 0.02 }, silver: [300, 600], tier: 4, image: 'ghost_knight.png' },
    ...
    5: [
        { id: 'OGRE', name: 'Ogre', health: 10000, damage: 450, defense: 250, xp: 1000, loot: { 'T5_DUNGEON_MAP': 0.01 }, silver: [600, 1200], tier: 5, image: 'ogre.png' },
        { id: 'WAR_OGRE', name: 'War Ogre', health: 15000, damage: 600, defense: 350, xp: 1600, loot: { 'T5_DUNGEON_MAP': 0.02 }, silver: [1000, 2000], tier: 5, image: 'war_ogre.png' },
    ...
    6: [
        { id: 'TROLL', name: 'Mountain Troll', health: 30000, damage: 1200, defense: 600, xp: 2500, loot: { 'T6_DUNGEON_MAP': 0.01 }, silver: [1500, 3000], tier: 6, image: 'troll.png' },
        { id: 'ARMORED_TROLL', name: 'Armored Troll', health: 45000, damage: 1600, defense: 800, xp: 4000, loot: { 'T6_DUNGEON_MAP': 0.02 }, silver: [2500, 4500], tier: 6, image: 'armored_troll.png' },
    ...
    7: [
        { id: 'DRAGON_WHELP', name: 'Dragon Whelp', health: 90000, damage: 3500, defense: 1500, xp: 7000, loot: { 'T7_DUNGEON_MAP': 0.01 }, silver: [3500, 7000], tier: 7, image: 'dragon_whelp.png' },
        { id: 'FIRE_DRAKE', name: 'Fire Drake', health: 130000, damage: 4500, defense: 2000, xp: 11000, loot: { 'T7_DUNGEON_MAP': 0.02 }, silver: [5500, 9500], tier: 7, image: 'fire_drake.png' },
    ...
    8: [
        { id: 'ANCIENT_GOLEM', name: 'Ancient Golem', health: 250000, damage: 9000, defense: 4000, xp: 18000, loot: { 'T8_DUNGEON_MAP': 0.01 }, silver: [8000, 16000], tier: 8, image: 'ancient_golem.png' },
        { id: 'OBSIDIAN_GOLEM', name: 'Obsidian Golem', health: 350000, damage: 12000, defense: 5500, xp: 28000, loot: { 'T8_DUNGEON_MAP': 0.02 }, silver: [14000, 24000], tier: 8, image: 'obsidian_golem.png' },
    ...
    9: [
        { id: 'ELDER_DRAGON', name: 'Elder Dragon', health: 700000, damage: 25000, defense: 10000, xp: 50000, loot: { 'T9_DUNGEON_MAP': 0.01 }, silver: [18000, 36000], tier: 9, image: 'elder_dragon.png' },
        { id: 'VOID_DRAGON', name: 'Void Dragon', health: 1000000, damage: 32000, defense: 13000, xp: 80000, loot: { 'T9_DUNGEON_MAP': 0.02 }, silver: [30000, 55000], tier: 9, image: 'void_dragon.png' },
    ...
    10: [
        { id: 'ANCIENT_DRAGON', name: 'Ancient Dragon', health: 3000000, damage: 60000, defense: 25000, xp: 150000, loot: { 'T10_DUNGEON_MAP': 0.01 }, silver: [40000, 80000], tier: 10, image: 'ancient_dragon.png' },
        { id: 'VOID_DRAGON_LORD', name: 'Void Dragon Lord', health: 4500000, damage: 85000, defense: 35000, xp: 250000, loot: { 'T10_DUNGEON_MAP': 0.02 }, silver: [70000, 130000], tier: 10, image: 'void_dragon_lord.png' },
