...
const QUALITY = 2; // Outstanding (index 2: 0=Normal, 1=Good, 2=Outstanding, 3=Excellent, 4=Masterpiece)
// Wait, MAGE_STATS_FIXED uses numeric keys for quality? 0, 1, 2, 3, 4?
// Let's check the keys in the file.
...
for (const t of TIERS) {
    ...
    // Sum stats from all gear pieces
    let gearHP = 0;
    let gearDef = 0;
    let gearDmg = 0;
    let gearSpd = 0;
...
console.log(JSON.stringify(playerStatsPerTier, null, 2));
