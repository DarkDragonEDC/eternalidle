...
const SocialPanel = ({ socket, isOpen, onClose, onInvite, onOpenTrade, tradeInvites, gameState, onInspect, isPreviewActive, onPreviewActionBlocked }) => {
    ...
    if (isIronman && socialTab === 'TRADE') {
        return (
            <div
                ...
                >
                    <button onClick={onClose} style={{ position: 'absolute', top: '20px', right: '20px', background: 'transparent', border: 'none', color: 'var(--text-dim)', cursor: 'pointer', zIndex: 10 }}>
                        <X size={24} />
                    </button>
                    ...
                    <div style={{
                        ...
                        <div>
                            ...
                            <p style={{ color: 'var(--text-dim)', maxWidth: '350px', lineHeight: '1.6', fontSize: '1rem', margin: 0 }}>
    ...
    return (
        <div
            ...
            style={{
                position: 'fixed', inset: 0, zIndex: 12000,
                background: 'var(--glass-bg)', backdropFilter: 'blur(5px)',
                display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px'
            }}>
            <motion.div
                onClick={e => e.stopPropagation()}
            ...
            >
                ...
                <div style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                        ...
                        <h2 style={{ margin: 0, fontSize: '1.1rem', fontWeight: '900', letterSpacing: '1px', color: 'var(--text-main)' }}>SOCIAL CENTER</h2>
                    </div>
                ...
                <div style={{
                    ...
                    {[
                        ...
                        <button
                            ...
                            style={{
                                flex: 1, padding: '10px', background: socialTab === tab.id ? 'var(--glass-bg)' : 'transparent',
                                border: 'none',
                                borderRadius: '8px',
                                color: socialTab === tab.id ? 'var(--accent)' : 'var(--text-dim)',
                                fontWeight: '900', fontSize: '0.75rem', cursor: 'pointer',
                                letterSpacing: '1px', transition: '0.3s cubic-bezier(0.4, 0, 0.2, 1)',
                                display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px',
                                boxShadow: socialTab === tab.id ? 'var(--panel-shadow)' : 'none'
                            }}
                        >
                            {tab.icon} {tab.label}
                        </button>
                                ...
                                {[
                                    ...
                                    <button
                                        ...
                                        style={{
                                            ...
                                            background: friendsSubTab === tab.key ? 'var(--accent)' : 'var(--slot-bg)',
                                            color: friendsSubTab === tab.key ? (tab.limitReached ? '#ef4444' : 'var(--bg-main)') : (tab.limitReached ? '#ef4444' : 'var(--text-dim)'),
                                    ...
                                    >
                                        ...
                                        {tab.badge > 0 && (
                                            <span style={{
                                                ...
                                                background: '#ef4444', color: 'var(--text-main)', fontSize: '0.6rem',
                                        ...
                                        <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                                            {friends.filter(f => f.isBestFriend || f.bestFriendRequestSender).sort((a, b) => b.isOnline - a.isOnline).map(friend => (
                                                <motion.div
                                                    ...
                                                    style={{
                                                        padding: '12px',
                                                        background: friend.isBestFriend ? 'var(--accent-soft)' : 'var(--slot-bg)',
                                                        borderRadius: '16px',
                                                        border: friend.isBestFriend ? '1px solid var(--accent)' : '1px solid var(--border)',
                                                        ...
                                                        <>
                                                            <div style={{ flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column', gap: '8px' }}>
                                                                ...
                                                                <div style={{ paddingLeft: '4px' }}>
                                                                    <div style={{ fontSize: '0.6rem', color: 'var(--text-dim)', marginBottom: '4px' }}>
                                                                        Best Friend
                                                                    </div>
                                                                    {friend.friendsSince && (
                                                            ...
                                                            <div style={{
                                                                ...
                                                                <button
                                                                    onClick={() => !friend.isIronman && onInvite(friend.friendName)}
                                                                    disabled={friend.isIronman}
                                                                    style={{
                                                                        background: 'transparent',
                                                                        border: 'none',
                                                                        color: friend.isIronman ? 'var(--accent-soft)' : 'var(--text-dim)',
                                                                        cursor: friend.isIronman ? 'not-allowed' : 'pointer',
                                                                        padding: '4px'
                                                                    }}
                                                                    title={friend.isIronman ? 'Ironman characters cannot trade' : 'Send Trade Invite'}
                                                                >
                                                                    {friend.isIronman ? <Shield size={16} /> : <ArrowLeftRight size={16} />}
                                                                </button>
                                                                <button
                                                                ...
                                                                {friend.bestFriendRequestSender === friend.friendId ? (
                                                                    ...
                                                                    <>
                                                                        <button
                                                                            onClick={() => {
                                                                                if (isPreviewActive) return onPreviewActionBlocked();
                                                                                socket.emit('respond_best_friend', { friendId: friend.friendId, accept: true });
                                                                            }}
                                                                        ...
                                                                        <button
                                                                            onClick={() => {
                                                                                if (isPreviewActive) return onPreviewActionBlocked();
                                                                                socket.emit('respond_best_friend', { friendId: friend.friendId, accept: false });
                                                                            }}
                                    ...
                                    {isLoadingFriends ? (
                                        ...
                                        <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                                            {friends.filter(f => f.status === 'ACCEPTED').sort((a, b) => b.isOnline - a.isOnline).map(friend => (
                                                <motion.div
                                                    key={friend.id}
                                                    whileHover={{ x: 5, background: 'var(--accent-soft)', borderColor: 'var(--border-active)' }}
                                                    style={{
                                                        padding: '12px', background: 'var(--slot-bg)',
                                                ...
                                                >
                                                    <div style={{ flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column', gap: '8px' }}>
                                                        ...
                                                        <div style={{ paddingLeft: '4px' }}>
                                                            {friend.friendsSince && (
                                                                <div style={{ fontSize: '0.55rem', color: 'var(--text-dim)', fontStyle: 'italic' }}>
                                                    ...
                                                    <div style={{
                                                        ...
                                                        <button
                                                            ...
                                                            style={{
                                                                background: 'transparent',
                                                                border: 'none',
                                                                color: friend.isIronman ? 'rgba(255,255,255,0.05)' : 'var(--text-dim)',
                                                                cursor: friend.isIronman ? 'not-allowed' : 'pointer',
                                                                padding: '4px'
                                                            }}
                                                            title={friend.isIronman ? 'Ironman characters cannot trade' : 'Send Trade Invite'}
                                        ...
                                        <div style={{ display: 'flex', gap: '10px' }}>
                                            <div style={{ flex: 1, position: 'relative' }}>
                                                <input
                                                    ...
                                                    style={{
                                                        ...
                                                        color: 'var(--text-main)', outline: 'none', transition: '0.2s', fontSize: '0.85rem'
                                                    }}
                                                />
                                            ...
                                            <button
                                                ...
                                                style={{
                                                    ...
                                                    color: 'var(--bg-main)', fontWeight: '800', border: 'none', cursor: 'pointer', transition: '0.2s'
                                                }}
                                            >
                                            ...
                                            >
                                                ...
                                                {friendSearchResults.map(result => (
                                                    <motion.div
                                                        ...
                                                        style={{
                                                            padding: '12px 16px', background: 'var(--slot-bg)',
                                                    ...
                                                    >
                                                        <div style={{ display: 'flex', flexDirection: 'column', gap: '6px', flex: 1 }}>
                                                            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                                                                ...
                                                                <div style={{ display: 'flex', alignItems: 'center', gap: '8px', minWidth: 0 }}>
                                                                    <span style={{
                                                                        fontSize: '0.95rem', fontWeight: '900', color: 'var(--text-main)',
                                                                        maxWidth: '120px', overflow: 'hidden', textOverflow: 'ellipsis',
                                                                        whiteSpace: 'nowrap', display: 'inline-block'
                                                                    }}>{result.name}</span>
                                                        ...
                                                        >
                                                            <div style={{ display: 'flex', flexDirection: 'column', gap: '6px', flex: 1 }}>
                                                                <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                                                                    ...
                                                                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', minWidth: 0 }}>
                                                                        <div style={{
                                                                            color: 'var(--text-main)', fontSize: '0.95rem', fontWeight: '900',
                                                                            maxWidth: '120px', overflow: 'hidden', textOverflow: 'ellipsis',
                                                                            whiteSpace: 'nowrap'
                                                                        }}>{req.friendName}</div>
                                                            ...
                                                            <div style={{
                                                                ...
                                                                <button
                                                                    onClick={() => {
                                                                        if (isPreviewActive) return onPreviewActionBlocked();
                                                                        socket.emit('respond_friend_request', { requestId: req.id, accept: true });
                                                                    }}
                                                                    style={{
                                                                        padding: '8px 15px', background: 'var(--accent)', color: 'var(--bg-main)',
                                                                ...
                                                                <button
                                                                    onClick={() => {
                                                                        if (isPreviewActive) return onPreviewActionBlocked();
                                                                        socket.emit('respond_friend_request', { requestId: req.id, accept: false });
                                                                    }}
                                                                    style={{
            ...
            <AnimatePresence>
                {friendToRemove && (
                    <div
                        ...
                        >
                            <h3 style={{ margin: '0 0 15px 0', color: 'var(--text-main)', fontSize: '1.1rem' }}>Remove Friend?</h3>
                            <p style={{ color: 'var(--text-dim)', fontSize: '0.9rem', marginBottom: '25px', lineHeight: '1.5' }}>
                                Are you sure you want to remove <span style={{ color: 'var(--text-main)', fontWeight: 'bold' }}>{friendToRemove.friendName}</span> from your friends list?
                            </p>
                            <div style={{ display: 'flex', gap: '12px', justifyContent: 'center' }}>
                                ...
                                <button
                                    ...
                                    style={{
                                        ...
                                        color: 'var(--bg-main)', border: 'none',
                                        borderRadius: '12px', fontWeight: '900', fontSize: '0.85rem', cursor: 'pointer',
                                        boxShadow: 'var(--panel-shadow)', transition: '0.3s'
                                    }}
                                >REMOVE</button>
                            </div>
                        </motion.div>
                ...
                {requestToCancel && (
                    <div
                        ...
                        >
                            <h3 style={{ margin: '0 0 15px 0', color: 'var(--text-main)', fontSize: '1.1rem' }}>Cancel Friend Request?</h3>
                            <p style={{ color: 'var(--text-dim)', fontSize: '0.9rem', marginBottom: '25px', lineHeight: '1.5' }}>
                                Are you sure you want to cancel the request sent to <span style={{ color: 'var(--text-main)', fontWeight: 'bold' }}>{requestToCancel.friendName}</span>?
                            </p>
                            <div style={{ display: 'flex', gap: '12px', justifyContent: 'center' }}>
                                <button
                                    onClick={() => setRequestToCancel(null)}
                ...
                {bestFriendToConfirm && (
                    <div
                        ...
                        >
                            ...
                            <p style={{ color: 'var(--text-dim)', fontSize: '0.9rem', marginBottom: '25px', lineHeight: '1.5' }}>
                                Do you want to send a Best Friend request to <span style={{ color: 'var(--text-main)', fontWeight: 'bold' }}>{bestFriendToConfirm.friendName}</span>?
                            </p>
                            <div style={{ display: 'flex', gap: '12px', justifyContent: 'center' }}>
                                <button
                                    onClick={() => setBestFriendToConfirm(null)}
                ...
                {bestFriendToRemove && (
                    <div
                        onClick={() => setBestFriendToRemove(null)}
                        style={{
                            position: 'fixed', inset: 0, zIndex: 13000,
                            background: 'rgba(0,0,0,0.8)', backdropFilter: 'blur(5px)',
                            display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px'
                        ...
                        >
                            <div style={{
                                ...
                                alignItems: 'center', justifyContent: 'center',
                                margin: '0 auto 15px', border: '1px solid rgba(239, 68, 68, 0.2)'
                            }}>
                                <X size={30} color="#ef4444" />
                            </div>
                            <h3 style={{ margin: '0 0 10px 0', color: '#ef4444', fontSize: '1.2rem', fontWeight: '900' }}>Remover Melhor Amigo?</h3>
                            <p style={{ color: 'var(--text-dim)', fontSize: '0.9rem', marginBottom: '25px', lineHeight: '1.5' }}>
                                {bestFriendToRemove.isBestFriend
                                    ? `Tem certeza que deseja remover ${bestFriendToRemove.friendName} da sua lista de melhores amigos?`
                                    : `Deseja cancelar o pedido de Melhor Amigo para ${bestFriendToRemove.friendName}?`
                                }
                            </p>
                            <div style={{ display: 'flex', gap: '12px', justifyContent: 'center' }}>
                                <button
                                ...
                                <button
                                    onClick={() => {
                                        if (isPreviewActive) return onPreviewActionBlocked();
                                        socket.emit('remove_best_friend', { friendId: bestFriendToRemove.friendId });
                                        setBestFriendToRemove(null);
                                    }}
                                    style={{
                                        flex: 1, padding: '12px', background: '#ef4444',
