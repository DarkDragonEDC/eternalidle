        ...
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, zIndex: 10000, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px' }}>
            ...
            <motion.div initial={{ scale: 0.9, opacity: 0, y: 20 }} animate={{ scale: 1, opacity: 1, y: 0 }} exit={{ scale: 0.9, opacity: 0, y: 20 }}
                style={{
                    ...
                    borderRadius: '20px', border: '1px solid var(--border)', boxShadow: 'var(--panel-shadow)',
                ...
                <div style={{ padding: '12px 16px 8px', display: 'flex', flexDirection: 'column', alignItems: 'center', position: 'relative' }}>
                    ...
                    <div style={{
                        width: '56px', height: '56px', background: 'var(--slot-bg)', borderRadius: '14px', border: '1px solid var(--border)',
                ...
                <div style={{ padding: '0 16px 12px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
                    ...
                    <div className="glass-panel" style={{ padding: '10px 12px', borderRadius: '12px', background: 'var(--accent-soft)' }}>
                        ...
                        <div style={{ display: 'flex', gap: '8px' }}>
                            <input
                                ...
                                style={{ flex: 1, background: 'var(--slot-bg)', border: '1px solid var(--border)', borderRadius: '8px', padding: '6px 8px', color: 'var(--text-main)', fontSize: '1rem', fontWeight: 'bold', outline: 'none' }}
                            />
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: materialStatus.length > 2 ? '1fr 1fr 1fr' : '1fr 1fr', gap: '6px' }}>
                                {materialStatus.map(m => {
                                    ...
                                    return (
                                        <div key={m.reqId} style={{ background: 'var(--slot-bg)', padding: '6px 8px', borderRadius: '8px', border: `1px solid ${ok ? 'var(--border-active)' : 'rgba(248, 113, 113, 0.15)'}`, cursor: 'pointer', position: 'relative' }}>
                    ...
                    {(['FOOD', 'POTION'].includes(resolvedItem.type) || resolvedItem.id.includes('FOOD') || resolvedItem.id.includes('POTION')) && (
                        <div style={{ background: 'var(--accent-soft)', padding: '12px', borderRadius: '14px', border: '1px solid var(--border)' }}>
                    ...
                    <div className="glass-panel" style={{ padding: '12px', borderRadius: '14px', background: 'var(--accent-soft)', border: '1px solid var(--border)' }}>
                        ...
                        <div style={{ marginTop: '8px', paddingTop: '8px', borderTop: '1px dashed var(--border)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            <span style={{ fontSize: '0.75rem', fontWeight: '900', color: 'var(--text-main)' }}>PROJECTED XP</span>
