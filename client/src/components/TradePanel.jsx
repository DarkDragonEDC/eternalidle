            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: isMobile ? '6px' : '10px' }}>
                        ...
                        <h1 style={{ margin: 0, fontSize: isMobile ? '1rem' : '1.5rem', fontWeight: '900', color: 'var(--text-main)', letterSpacing: '2px' }}>TRADING</h1>
                        {!isMobile && (
                            <span style={{ fontSize: '0.8rem', color: 'var(--text-dim)', padding: '4px 10px', background: 'var(--slot-bg)', borderRadius: '20px' }}>
                    ...
                    <div style={{ display: 'flex', gap: '8px' }}>
                        ...
                        <button onClick={handleExplicitClose} style={{ background: 'rgba(255,255,255,0.1)', color: '#fff', border: '1px solid rgba(255,255,255,0.2)', padding: '8px', borderRadius: '8px', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                            <X size={18} />
                        </button>
                    </div>
                </div>
                ...
                <div style={{
                    ...
                    {(!isMobile || mobileTab === 'OFFER') && (
                        <div className="glass-panel" style={{ display: 'flex', flexDirection: 'column', background: 'var(--glass-bg)', padding: isMobile ? '10px' : '15px', borderRadius: '16px', border: '1px solid var(--border)', height: '100%', overflow: 'hidden' }}>
                    ...
                    {(!isMobile || mobileTab === 'INVENTORY') && (
                        <div style={{ display: 'flex', flexDirection: 'column', gap: isMobile ? '10px' : '15px', overflow: 'hidden', height: '100%' }}>
                            <div className="glass-panel" style={{ padding: isMobile ? '10px' : '15px', borderRadius: '16px', border: '1px solid var(--border)', background: 'var(--glass-bg)' }}>
                            ...
                            <div className="glass-panel" style={{ flex: 1, padding: isMobile ? '10px' : '15px', borderRadius: '16px', border: '1px solid var(--border)', background: 'var(--glass-bg)', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
                                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: isMobile ? '5px' : '10px' }}>
                                    ...
                                    <div style={{ position: 'relative', width: isMobile ? '100px' : '120px' }}>
                                        <input
                                            ...
                                            style={{
                                                ...
                                                color: 'var(--text-main)', fontSize: '0.7rem', outline: 'none'
                                            }}
                                        />
                        ...
                        <div className="glass-panel" style={{ display: 'flex', flexDirection: 'column', background: 'rgba(144,213,255,0.02)', padding: isMobile ? '10px' : '15px', borderRadius: '16px', border: '1px solid rgba(144,213,255,0.1)', height: '100%', overflow: 'hidden' }}>
                            ...
                            <div style={{ flex: 1, overflowY: 'auto', display: 'flex', flexDirection: 'column', gap: '10px' }}>
                                ...
                                {partnerOffer.silver > 0 && (
                                    <div style={{ display: 'flex', alignItems: 'center', gap: isMobile ? '6px' : '10px', padding: isMobile ? '8px' : '12px', background: 'var(--slot-bg)', borderRadius: '10px' }}>
                                        <Coins size={isMobile ? 16 : 18} color="var(--accent)" />
                    ...
                    {quantityModal.isOpen && (
                        <div style={{
                            ...
                            <motion.div
                                ...
                                style={{
                                    background: 'var(--panel-bg)', borderRadius: '16px', border: '1px solid var(--border)',
                                ...
                                <div style={{ display: 'flex', gap: '8px' }}>
                                    <input
                                        ...
                                        style={{
                                            ...
                                            background: 'var(--slot-bg)', color: 'var(--text-main)', fontSize: '1.2rem', textAlign: 'center',
