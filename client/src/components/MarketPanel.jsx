            ...
            <div className="panel" style={{
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid var(--border)', paddingBottom: '15px', flexWrap: 'wrap', gap: '10px' }}>
                    ...
                    <div style={{ display: 'flex', background: 'var(--glass-bg)', borderRadius: '12px', padding: '4px', flexWrap: 'wrap', justifyContent: 'center' }}>
                        <button onClick={() => setActiveTab('BUY')} style={{ padding: '8px 16px', borderRadius: '8px', border: 'none', cursor: 'pointer', fontSize: '0.85rem', fontWeight: 'bold', background: activeTab === 'BUY' ? 'var(--accent-soft)' : 'transparent', color: activeTab === 'BUY' ? 'var(--accent)' : 'var(--text-dim)', border: activeTab === 'BUY' ? '1px solid var(--accent)' : '1px solid transparent', transition: '0.2s' }}>Sell Orders</button>
                        <button onClick={() => setActiveTab('BUY_ORDERS')} style={{ padding: '8px 16px', borderRadius: '8px', border: 'none', cursor: 'pointer', fontSize: '0.85rem', fontWeight: 'bold', background: activeTab === 'BUY_ORDERS' ? 'var(--accent-soft)' : 'transparent', color: activeTab === 'BUY_ORDERS' ? 'var(--accent)' : 'var(--text-dim)', border: activeTab === 'BUY_ORDERS' ? '1px solid var(--accent)' : '1px solid transparent', transition: '0.2s' }}>Buy Orders</button>
                        <button onClick={() => setActiveTab('MY_ORDERS')} style={{ padding: '8px 16px', borderRadius: '8px', border: 'none', cursor: 'pointer', fontSize: '0.85rem', fontWeight: 'bold', background: activeTab === 'MY_ORDERS' ? 'var(--accent-soft)' : 'transparent', color: activeTab === 'MY_ORDERS' ? 'var(--accent)' : 'var(--text-dim)', border: activeTab === 'MY_ORDERS' ? '1px solid var(--accent)' : '1px solid transparent', transition: '0.2s' }}>My Listings</button>
                        <button onClick={() => setActiveTab('SELL')} style={{ padding: '8px 16px', borderRadius: '8px', border: 'none', cursor: 'pointer', fontSize: '0.85rem', fontWeight: 'bold', background: activeTab === 'SELL' ? 'var(--accent-soft)' : 'transparent', color: activeTab === 'SELL' ? 'var(--accent)' : 'var(--text-dim)', border: activeTab === 'SELL' ? '1px solid var(--accent)' : '1px solid transparent', transition: '0.2s' }}>Sell</button>
                        <button onClick={() => setActiveTab('CLAIM')} style={{ position: 'relative', padding: '8px 16px', borderRadius: '8px', border: 'none', cursor: 'pointer', fontSize: '0.85rem', fontWeight: 'bold', background: activeTab === 'CLAIM' ? 'var(--accent-soft)' : 'transparent', color: activeTab === 'CLAIM' ? 'var(--accent)' : 'var(--text-dim)', border: activeTab === 'CLAIM' ? '1px solid var(--accent)' : '1px solid transparent', transition: '0.2s' }}>Claim {gameState?.state?.claims?.length > 0 && <span style={{ position: 'absolute', top: '-2px', right: '-2px', background: '#ff4444', color: '#fff', borderRadius: '50%', width: '16px', height: '16px', fontSize: '0.65rem', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>{gameState?.state?.claims?.length}</span>}</button>
                        <button onClick={() => setActiveTab('HISTORY')} style={{ padding: '8px 16px', borderRadius: '8px', border: 'none', cursor: 'pointer', fontSize: '0.85rem', fontWeight: 'bold', background: activeTab === 'HISTORY' ? 'var(--accent-soft)' : 'transparent', color: activeTab === 'HISTORY' ? 'var(--accent)' : 'var(--text-dim)', border: activeTab === 'HISTORY' ? '1px solid var(--accent)' : '1px solid transparent', transition: '0.2s' }}>History</button>
                    </div>
                </div>
