...
const RunePanel = ({ gameState, onShowInfo, isMobile, socket, onListOnMarket, onOpenShop, activeCategory, onTutorialComplete, isPreviewActive, onPreviewActionBlocked }) => {
            ...
            <div style={{ display: 'flex', gap: '10px' }}>
                <button
                    ...
                    style={{
                        ...
                        color: activeTab === 'shards' ? 'var(--bg-dark)' : 'var(--text-dim)',
                        fontWeight: 'bold',
                        cursor: 'pointer',
                        transition: '0.2s',
                        display: 'flex',
                ...
                <button
                    ...
                    style={{
                        ...
                        color: activeTab === 'runes' ? 'var(--bg-dark)' : 'var(--text-dim)',
                        fontWeight: 'bold',
                        cursor: 'pointer',
                        transition: '0.2s',
                        display: 'flex',
                            ...
                            {['ALL', 'GATHERING', 'REFINING', 'CRAFTING', 'COMBAT'].map(cat => (
                                <button
                                    ...
                                    style={{
                                        ...
                                        color: categoryFilter === cat ? 'var(--bg-dark)' : 'var(--text-dim)',
                        ...
                        <div style={{ display: 'flex', gap: '10px' }}>
                            ...
                            <button
                                ...
                                style={{
                                    ...
                                    color: isFilterExpanded ? 'var(--bg-dark)' : 'var(--text-dim)',
                                ...
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '5px' }}>
                                    ...
                                    <button
                                        ...
                                        style={{
                                            ...
                                            color: showThreePlus ? 'var(--bg-dark)' : 'var(--text-dim)',
                                            border: '1px solid var(--border)',
                                            cursor: 'pointer',
                                            transition: '0.2s',
                                            display: 'flex',
                            ...
                            <div style={{ background: 'var(--slot-bg)', padding: '15px', borderRadius: '10px', marginBottom: '20px' }}>
                                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '10px' }}>
                                    <button
                                        ...
                                        style={{ padding: '8px 12px', background: 'var(--slot-bg)', border: '1px solid var(--border)', color: 'var(--text-dim)', borderRadius: '6px', cursor: 'pointer', fontWeight: 'bold', fontSize: '0.7rem' }}
                                    >
                                        MIN
                                    </button>
                                    <input
            ...
            {/* BATCH ACTION MODAL */}
            {
                batchModal && createPortal(
                    <div style={{
                        ...
                        <div style={{
                            background: 'var(--panel-bg)', border: '1px solid var(--border)',
                            borderRadius: '16px', padding: '16px', width: '90%', maxWidth: '340px',
                            boxShadow: '0 20px 50px rgba(0,0,0,0.6)', position: 'relative'
                        }} onClick={e => e.stopPropagation()}>
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: '15px', marginBottom: '12px' }}>
                                <div style={{
                                    ...
                                    {batchModal.item.id.includes('SHARD') ? <Package size={22} /> : (batchModal.item.icon ? <img src={batchModal.item.icon} alt="" style={{ width: '80%', height: '80%', objectFit: 'contain' }} /> : <Package size={22} />)}
                                </div>
                                <div>
                                    <div style={{ fontWeight: 'bold', color: 'var(--text-main)' }}>{batchModal.item.name}</div>
                                    <div style={{ fontSize: '0.8rem', color: 'var(--accent)' }}>
                                        {batchModal.type === 'FORGE' ? 'Forge Cost' : 'Merge Cost'}: {formatNumber(batchModal.type === 'FORGE' ? 100 : 2 * batchModal.item.tier)} Silver
                                    </div>
                                </div>
                            </div>

                            <div style={{ background: 'var(--slot-bg)', padding: '10px', borderRadius: '10px', marginBottom: '12px' }}>
                                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '10px' }}>
                                    <button
                            ...
                            <div style={{ textAlign: 'center', marginBottom: '12px', padding: '8px', background: 'rgba(255, 215, 0, 0.05)', borderRadius: '8px', border: '1px solid rgba(255, 215, 0, 0.1)' }}>
                                ...
                                <div style={{ fontSize: '1.2rem', fontWeight: '900', color: '#ffd700', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', marginTop: '2px' }}>
                            ...
                            <div style={{ display: 'flex', gap: '10px' }}>
                                <button
                                    onClick={() => setBatchModal(null)}
                                    style={{ flex: 1, padding: '10px', background: 'transparent', border: '1px solid rgba(255,255,255,0.1)', color: '#888', borderRadius: '8px', fontWeight: 'bold', cursor: 'pointer' }}
                                >
                                    CANCEL
                                </button>
                                <button
                    ...
                    <div style={{
                        ...
                        >
                            ...
                            <div style={{
                                ...
                                padding: '12px', background: 'var(--slot-bg)', borderRadius: '12px',
                                marginBottom: '20px',
