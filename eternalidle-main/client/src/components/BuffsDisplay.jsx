...
import { Star, Coins, Clover, Diamond, Hammer, Sprout, Wand2, ArrowUpCircle, Zap, Sword } from 'lucide-react';
...
const BuffsDisplay = ({ activeBuffs }) => {
    ...
    const getBuffInfo = (type) => {
        switch (type) {
            ...
            case 'SILVER': return { icon: <Coins size={16} color="var(--accent)" />, label: 'Silver Gain' };
            ...
            case 'CRIT': return { icon: <Zap size={16} color="#f59e0b" />, label: 'Critical' };
            case 'DAMAGE': return { icon: <Sword size={16} color="#ef4444" />, label: 'Damage' };
