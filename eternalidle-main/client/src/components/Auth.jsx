...
const Auth = ({ onLogin, initialView = 'LOGIN', theme, setTheme, isMobile, onPreviewTheme }) => {
    ...
    return (
        <div style={{
            ...
            {/* Theme Selector removed from Auth screen to lock colors here */}
            ...
            <motion.div
                ...
                style={{
                    ...
                    background: theme === 'light'
                        ? 'radial-gradient(circle, rgba(0, 51, 102, 0.1) 0%, transparent 70%)'
                        : theme === 'cyber'
                            ? 'radial-gradient(circle, rgba(0, 242, 255, 0.15) 0%, transparent 70%)'
                            : theme === 'rose'
                                ? 'radial-gradient(circle, rgba(255, 133, 161, 0.15) 0%, transparent 70%)'
                                : theme === 'nature'
            ...
            <motion.div
                ...
                style={{
                    ...
                    background: theme === 'rose'
                        ? 'radial-gradient(circle, rgba(255, 133, 161, 0.1) 0%, transparent 70%)'
                        : theme === 'nature'
                            ? 'radial-gradient(circle, rgba(134, 239, 172, 0.1) 0%, transparent 70%)'
                            : theme === 'arcane'
                                ? 'radial-gradient(circle, rgba(216, 180, 254, 0.1) 0%, transparent 70%)'
                                : theme === 'ice'
                                    ? 'radial-gradient(circle, rgba(147, 197, 253, 0.1) 0%, transparent 70%)'
                                    : theme === 'crimson'
                                        ? 'radial-gradient(circle, rgba(248, 113, 113, 0.1) 0%, transparent 70%)'
                                        : 'radial-gradient(circle, rgba(144, 213, 255, 0.1) 0%, transparent 70%)',
                ...
                >
                    ...
                    <motion.div
                        ...
                        style={{
                            ...
                            borderRadius: '24px', border: '1px solid var(--border-active)',
                                ...
                                >
                                    ...
                                    <motion.button
                                        ...
                                        style={{
                                            ...
                                            color: 'var(--bg-dark)',
                                            boxShadow: isLoading ? 'none' : '0 10px 25px var(--accent-soft)',
                                            padding: '10px'
                                        }}
                                    >
...
const inputStyle = {
    width: '100%', padding: '10px 10px 10px 40px', background: 'var(--slot-bg)',
    border: '1px solid var(--border)', borderRadius: '10px',
    color: 'var(--text-main)', fontSize: '0.9rem', outline: 'none', transition: '0.3s cubic-bezier(0.16, 1, 0.3, 1)',
};
...
const guestButtonStyle = {
    ...
    background: 'var(--accent-soft)',
    border: '1px solid var(--border-active)', borderRadius: '12px',
    color: 'var(--accent)', cursor: 'pointer', transition: '0.3s cubic-bezier(0.16, 1, 0.3, 1)',
};
