...
async function fullSync() {
    ...
    try {
        ...
        // 2. Get All Character Donations (from state)
        const charRes = await oldClient.query("SELECT id, name, (state->>'altar_total_donated')::bigint as donated FROM characters WHERE state->>'altar_total_donated' IS NOT NULL");
        ...
        `);
        console.log("Global Total Updated.");
