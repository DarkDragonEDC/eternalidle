...
const mockGameManager = {
    ...
    addNotification: (char, type, msg) => console.log([NOTIFICATION] : )
};
...
if (pruned.inventory['T6_PLANK::Creator'].craftedBy === 'Creator' && pruned.inventory['T6_PLANK::Creator'].id === 'T6_PLANK::Creator') {
