...
for (let t = 1; t <= 10; t++) {
    ...
    let actualFood = simulate(t, player, bestDmg, healPerUse);
    finalResults.push({ tier: t, dmg: bestDmg, food: actualFood });
}

console.log("TIER | MOB_DMG | FOOD_USED");
finalResults.forEach(r => console.log(`${r.tier} | ${r.dmg} | ${r.food}`));
